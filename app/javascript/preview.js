document.addEventListener('DOMContentLoaded', function(){
  ...
  const buildNewFileField = () => {
    ...
    newFileField.setAttribute('name', 'post_spot[images][]');

    // 最後のfile_fieldを取得
    const lastFileField = document.querySelector('input[type="file"][name="post_spot[images][]"]:last-child');
  ...
  // input要素を取得
  const fileField = document.querySelector('input[type="file"][name="post_spot[images][]"]');
